  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-between bg-orange-500 dark:bg-orange-600 rounded-lg shadow-lg p-6">
          ...
          <Button
            ...
            className="bg-white border-white hover:bg-orange-100"
          >
            {actualTheme === "dark" ? (
