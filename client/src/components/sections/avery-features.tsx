      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-32 items-center">
          <motion.div 
            ...
            transition={{ duration: 0.8 }}
          >
            <Badge className="mb-4 bg-white/10 text-white hover:bg-white/20 border-white/20">DISCOVERY</Badge>
             ...
             <div className="relative aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-zinc-900 to-black border border-white/10 p-8 flex items-center justify-center">
               <div className="relative z-10 grid grid-cols-2 gap-4">
                  ...
                  <motion.div 
                    ...
                    className="bg-white/10 p-4 rounded-xl border border-white/30 shadow-[0_0_30px_-5px_rgba(255,255,255,0.15)]"
                  >
                 ...
                 <div className="w-full space-y-4">
                    <div className="flex items-center justify-between border-b border-white/10 pb-4">
                       <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-mono text-white">AGENT ACTIVE</span>
                       </div>
                    ...
                    <div className="space-y-2">
                       <div className="bg-white/5 p-3 rounded text-xs font-mono text-white/50">
                          {'>'} Searching for candidates...
                       </div>
                       <div className="bg-white/5 p-3 rounded text-xs font-mono text-white/50">
                          {'>'} Found 12 matches.
                       </div>
                       <div className="bg-white/10 p-3 rounded text-xs font-mono text-white border border-white/20">
