...
export default function EmployeeOnboarding() {
  ...
  const getStatusBadge = (status: NewEmployee["onboardingStatus"]) => {
    switch (status) {
      case "pending":
        return <Badge className="bg-gray-500/20 text-gray-400 border-0">Pending</Badge>;
      case "in_progress":
        return <Badge className="bg-blue-500/20 text-blue-400 border-0">In Progress</Badge>;
      case "completed":
        return <Badge className="bg-green-500/20 text-green-400 border-0"><CheckCircle2 className="h-3 w-3 mr-1" />Completed</Badge>;
    }
  };
