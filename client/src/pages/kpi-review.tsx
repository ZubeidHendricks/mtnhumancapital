    ...
    <Card className="bg-gray-900/50 border-border dark:border-white/10" data-testid={`kpi-card-${assignment.id}`}>
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          ...
          <div>
            <p className="text-gray-400">Measurement</p>
        ...
        <div className="border-t border-border dark:border-white/10 pt-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {hasManagerScore && (
              <div>
                <Label className="text-sm text-gray-400 mb-2 block">Manager Score</Label>
                <div className="flex items-center gap-4">
                  <StarRating
        ...
        {assignment.score?.managerComments && (
          <div className="bg-gray-800/50 p-3 rounded-lg">
            <Label className="text-sm text-gray-400 mb-1 block">Manager Feedback</Label>
            <p className="text-white text-sm">{assignment.score.managerComments}</p>
          </div>
        )}
      </CardContent>
    </Card>
                ...
                <CardContent className="py-4">
                  <div className="flex items-center justify-between flex-wrap gap-4">
                    <div className="flex items-center gap-6">
                      <div>
                        <p className="text-sm text-gray-400">Review Period</p>
                        <p className="text-white font-medium">
                ...
                {isSubmitted && currentSubmission?.managerReviewStatus === "pending" && (
                  <Card className="bg-amber-900/20 border-amber-500/30">
                    <CardContent className="py-6 text-center">
                      ...
                      <h3 className="text-lg font-semibold text-white mb-1">Awaiting Manager Review</h3>
                      <p className="text-gray-400">
                    ...
                    <CardContent className="py-6">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400">Your manager has completed the review</p>
                        </div>
                      </div>
                      ...
                      {currentSubmission.managerComments && (
                        <div className="mt-4">
                          <p className="text-sm text-gray-400 mb-1">Manager Comments</p>
                          <p className="text-white">{currentSubmission.managerComments}</p>
                        </div>
                      )}
                    </CardContent>
                  </Card>
